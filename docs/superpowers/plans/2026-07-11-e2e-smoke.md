...
- ASCII only. Seeded admin: `admin@gardik.local` / `ChangeMe123!` (defaults in `prisma/seed.ts`).
    ...
    services:
      postgres:
        ...
        ports:
          - 5432:5432
        options: >-
          --health-cmd "pg_isready -U ci -d gardik"
          --health-interval 3s
          --health-timeout 3s
          --health-retries 20
    env:
      DATABASE_URL: postgresql://ci:ci@localhost:5432/gardik
