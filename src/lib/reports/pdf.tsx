...
export function reportPdf(sections: ReportSection[], data: ReportData): Promise<Buffer> {
  ...
  const doc = (
    <Document title="Gardik security report" author="Gardik" subject="Security exposure report">
      <Page size="A4" style={s.page}>
        <View style={s.band}>
          <View style={s.brandRow}>
            <View>
              <Text style={s.brand}>Gardik</Text>
        ...
        <View style={s.footer} fixed>
          <Text style={s.footText}>Gardik - confidential security report</Text>
